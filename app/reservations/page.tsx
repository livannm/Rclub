        ...
        <div className="rclub-fieldset">
          ...
          <div className="rclub-grid-2">
            <label className="rclub-field" htmlFor="date_requested">
              <span className="rclub-label">{t("dateRequested")}</span>
              <input
                id="date_requested"
                name="date_requested"
                type="date"
        ...
        <div className="rclub-fieldset">
          ...
          <div className="rclub-table-tiles" role="radiogroup" aria-label={t("tableType")}>
            ...
            <div className="rclub-table-tile">
              <input type="radio" id="table_standard" name="table_type" value="standard" />
              <label htmlFor="table_standard" className="rclub-table-tile-label">
                ...
                <span className="rclub-tile-name">{t("tableStandard")}</span>
                <span className="rclub-tile-sub">{t("tableStandardSub")}</span>
              </label>
            </div>
            ...
            <div className="rclub-table-tile">
              <input type="radio" id="table_lounge" name="table_type" value="lounge" />
              <label htmlFor="table_lounge" className="rclub-table-tile-label">
                <span className="rclub-tile-icon" aria-hidden="true">
                  <svg viewBox="0 0 32 32" width="32" height="32" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square">
                ...
                <span className="rclub-tile-name">{t("tableLounge")}</span>
                <span className="rclub-tile-sub">{t("tableLoungeSub")}</span>
              </label>
            </div>
