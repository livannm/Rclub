...
export default async function ReservationDetailPage({ params, searchParams }: Props) {
  ...
  const isEditable = reservation.status === "confirmed" || reservation.status === "new" || reservation.status === "reviewed" || reservation.status === "contacted";
  const canDecide = reservation.status === "new" || reservation.status === "reviewed" || reservation.status === "contacted";
