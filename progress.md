...
| F-08    | Changer logo                       | Codex | done   | unit+integration+e2e OK          | [#11](https://github.com/livannm/Rclub/pull/11) | PUT /api/admin/site-assets/logo, section admin, logo dynamique dans layout (fallback /media/logo.png) |
